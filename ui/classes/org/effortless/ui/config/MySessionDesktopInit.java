 ...
 */
public class MySessionDesktopInit implements org.zkoss.zk.ui.util.DesktopInit {
	public void init(Desktop desktop,  Object request) {
		service(desktop);
//		desktop.addListener(new MySessionDesktop());
	}
	
	
	
	public boolean service(Desktop desktop) {
