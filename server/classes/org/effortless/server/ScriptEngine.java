...
//        }
        ...
        protected CompilationUnit createCompilationUnit(CompilerConfiguration configuration, CodeSource source) {
            ...
            CompilationUnit cu = new CompilationUnit(configuration, source, this, this);
            
//            System.out.println(">>>>>>>>>>>>>>CompilationUnit createCompilationUnit ScriptEngine "+ source.getLocation());
    ...
    public static void main(String[] urls) throws Exception {
        ScriptEngine gse = new ScriptEngine(urls);
     ...
     */
    private ScriptEngine(URL[] roots, ClassLoader parent, ResourceConnector rc) {
    ...
    public ScriptEngine(String[] urls) throws IOException {
    ...
    public ScriptEngine(String[] urls, ClassLoader parentClassLoader) throws IOException {
        this(createRoots(urls), parentClassLoader, null);
    }

    public ScriptEngine(String url) throws IOException {
        this(new String[]{url});
    }

    public ScriptEngine(String url, ClassLoader parentClassLoader) throws IOException {
        this(new String[]{url}, parentClassLoader);
    }

    public ScriptEngine(ResourceConnector rc) {
        this(null, CL_STUB, rc);
    }

    public ScriptEngine(ResourceConnector rc, ClassLoader parentClassLoader) {
