...
//	static final Log log = LogFactory.getLog(FileUserType.class);
	...
	public Object deepCopy(Object o) {
		...
		java.sql.Time deepCopy = new java.sql.Time(((java.sql.Time)o).getTime());
		return deepCopy;
	}
	...
	public int hashCode(Object x) {
	 ...
	 SQLException {
		 ...
		 result = inResultSet.getTime(names[0]);
			return result;
	 }
	 ...
	 SessionImplementor si) throws HibernateException, SQLException {
		 if (o != null) {
			    java.sql.Time val = (java.sql.Time) o;
				inPreparedStatement.setTime(i, val);
		 }
		 else {
				inPreparedStatement.setNull(i, Types.TIME);
		 }
	 }
