...
//			tcs.addCatch(catchException);
	...
	public static String[] getActionCustomNames(ClassNode clazz, SourceUnit sourceUnit) {
		String[] result = null;
		if (clazz != null) {
...
//			List<MethodNode> methods = clazz.getAllDeclaredMethods();
			...
			for (MethodNode method : methods) {
				if (checkValidActionCustom(method, clazz, sourceUnit)) {
	...
	public static boolean checkValidActionCustom(MethodNode method, ClassNode clazz, SourceUnit sourceUnit) {
		boolean result = false;
		if (method != null) {
