...
<editor-window>
	 ...
	 * @param sourceUnit
	 */
	public static void writeZul(GClass clazz/*ClassNode vm, ClassNode clazz, SourceUnit sourceUnit*/) {
...
//		String vmName = EditorVM.class.getName();
		...
		List<FieldNode> properties = getEditorProperties(clazz);
		String varId = "editor";
